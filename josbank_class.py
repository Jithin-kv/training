...
class JosBank():
    def __init__(self,argument_category_url):
        self.logger = logging.getLogger()
        #self.argument_category_url = sys.argv[1]
        self.argument_category_url=argument_category_url
        ...
        self.start_request(self.argument_category_url)                     
                         ####pagerequest####
    ...
    def start_request(self,url):
        ...
        if next_page:
            self.start_request(next_page[0])
    ...
    def parse_product(self,url):
        ...
        price ="".join(price[0]) if price else''
...
obj = JosBank(argument_category_url)
